#!/usr/bin/env bash
# Generates Mov2Gif.dmg for distribution (unsigned / without Developer ID).
...
xcodebuild -project Mov2Gif.xcodeproj \
  -scheme Mov2Gif \
...
# Pega as versões diretamente do Info.plist recém-compilado do app
